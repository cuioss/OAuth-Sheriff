 ...
 * {@link de.cuioss.sheriff.oauth.quarkus.mapper.DiscoverableClaimMapper} for
 * Keycloak's default claim structures.
 * </p>
 * <p>
 * Available mappers:
 * <ul>
 *   <li>{@link de.cuioss.sheriff.oauth.quarkus.mapper.keycloak.KeycloakRolesMapperBean} -
 *       Maps Keycloak's {@code realm_access.roles} to {@code roles}</li>
 *   <li>{@link de.cuioss.sheriff.oauth.quarkus.mapper.keycloak.KeycloakGroupsMapperBean} -
