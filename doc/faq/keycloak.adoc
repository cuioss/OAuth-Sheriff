...
*Error:* `OAUTH_SHERIFF_QUARKUS-124: Bearer token validation failed: Missing mandatory claims: [sub]`
...
- Global CDI-based registration via the `DiscoverableClaimMapper` interface (Service Provider Interface)
