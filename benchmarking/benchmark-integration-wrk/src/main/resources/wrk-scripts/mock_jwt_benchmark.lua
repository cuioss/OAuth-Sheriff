-- Optimized WRK script for Mock JWT validation benchmark
-- Identical to jwt_benchmark.lua but targets /mock-jwt/validate endpoint
...
-- WRK already provides all the necessary statistics
