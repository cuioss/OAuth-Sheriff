...
* **Measured**: 88,700 req/s, P50 1.25ms (see link:../doc/Analysis-01.2026-Integration.adoc[Integration Analysis])
...
* **Measured**: 23,800 req/s, P50 5.49ms (see link:../doc/Analysis-01.2026-Integration.adoc[Integration Analysis])
