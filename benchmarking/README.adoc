...
* link:doc/Analysis-01.2026-Integration.adoc[Integration Benchmark Analysis (January 2026)] - WRK-based HTTP load testing with resource monitoring
* link:doc/Analysis-01.2026-Micro.adoc[Micro-Benchmark Analysis (January 2026)] - JMH library performance and validation pipeline breakdown
