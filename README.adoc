...
image:https://github.com/cuioss/OAuth-Sheriff/actions/workflows/github-code-scanning/codeql/badge.svg[CodeQL,link=https://github.com/cuioss/OAuth-Sheriff/security/code-scanning]
...
* xref:benchmarking/doc/Analysis-01.2026-Integration.adoc[Integration Benchmark Analysis (January 2026)] - WRK HTTP load testing analysis
* xref:benchmarking/doc/Analysis-01.2026-Micro.adoc[Micro-Benchmark Analysis (January 2026)] - JMH library performance analysis